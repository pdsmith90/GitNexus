...
/**
 * Julia merge bindings: first-wins by origin tier (local > import > wildcard),
 * dedup by def node id. Same shape as the C resolver — Julia has no namespace
 * or reexport precedence rules worth modeling for the first cut.
 */
export function juliaMergeBindings(
